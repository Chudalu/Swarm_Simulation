...
public class CRSettings {
    ...
    //-- flags
	private boolean isConsoleOnlyBuild; 	// if true, no GUI will be created when the application starts
	...
	private int maxUpdateDelay = 50; 			//defines max value of how long update thread waits between 2 updates, i.e. how many update loops in a simulated second
	...
	private int viewMovementSpeedByButton = 200;//defines by how much a view of world moves when a view movement control button is pressed
	private int viewMovementSpeedByKey = 100;	//defines by how much the view of world moves when an arrow key is pressed
	
    private CRSettings() 	{
    	windowSize = new Dimension(1230, 720);
    	shouldDraw = true;
		shouldPrintGraphicReports = true; 
		shouldPrintTextReports = true;	
		shouldQuitAfterDone = true; 
		isConsoleOnlyBuild = false;
	}
	...
	public int getViewMovementSpeedByButton() { return viewMovementSpeedByButton; }
	public void setViewMovementSpeedByButton(int value_) { viewMovementSpeedByButton = value_;}
	
	public int getViewMovementSpeedByKey() { return viewMovementSpeedByKey; }
	public void setViewMovementSpeedByKey(int value_) { viewMovementSpeedByKey = value_;}
	
	public boolean getIsConsoleOnlyBuild() { return isConsoleOnlyBuild; }
	public void setIsConsoleOnlyBuild(boolean is_) { isConsoleOnlyBuild = is_; }
